...
@Autonomous (name = "Rotate", group = "Spring Training")
public class ExampleAutonomousRotate extends LinearOpMode
{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        rightDrive.setPower(-1); // Sets rightDrive to move backwards at full power
        ...
        leftDrive.setPower(-1); // Sets leftDrive to move backwards at full power
